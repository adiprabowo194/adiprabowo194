...
* **Aplikasi Kurir & Modul Transporter**
* **Integrasi Payment Gateway** (Midtrans, vendor eksternal)
* **Integrasi Sistem Transporter/Vendor & 3rd-party API**

### 🛠️ Teknologi Pilihan (Tech Stack)

Berikut adalah teknologi utama yang saya gunakan, ditampilkan dengan badges:
...
## 🚀 Proyek Pilihan (Project Showcase)
